    ...
    public class RewardRepository
    {
        ...
        static RewardRepository()
        {
            ...
            responses.Add("Sashimi Salad 1", new Reward
            {
                ...
                Rewards = "Earn 1 Partner's Pub Pounders point per dollar of eligible purchases.",
            ...
            responses.Add("Seaweed Salad 1", new Reward 
            {
                ...
                Rewards = "Earn 10 Partner's Pub Pounders points per dollar of eligible purchases.",
            ...
            responses.Add("Edamame 1", new Reward
            {
                ...
                Rewards = "Earn 50 Partner's Pub Pounders points per dollar of eligible purchases.",
            ...
            responses.Add("Maguro 1", new Reward
            {
                ...
                Rewards = "Earn 20 Partner's Pub Pounders points per dollar of eligible purchases.",
            ...
            responses.Add("Tekka Maki 1", new Reward
            {
                ...
                Rewards = "Earn 30 Partner's Pub Pounders points per dollar of eligible purchases.",
